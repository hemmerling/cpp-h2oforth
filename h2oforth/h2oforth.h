...
#define SYSTEM_ARCHITECTURE_1632BIT 1
#define SYSTEM_ARCHITECTURE_3232BIT 2
#define SYSTEM_ARCHITECTURE_3264BIT 3
#define SYSTEM_ARCHITECTURE_64BIT 4

/* Start of configuration switches */
#define SYSTEM_ARCHITECTURE SYSTEM_ARCHITECTURE_HOST
//#define SYSTEM_ARCHITECTURE SYSTEM_ARCHITECTURE_1632BIT
//#define SYSTEM_ARCHITECTURE SYSTEM_ARCHITECTURE_3264BIT
...
#endif
#if (  SYSTEM_ARCHITECTURE == SYSTEM_ARCHITECTURE_1632BIT )
/* Emulation of 16B32IT targets for 3264BIT and 64BIT C compilers */
#undef INT_MIN
#undef INT_MAX
#undef UINT_MAX
#define INT_MIN -32768
...
#define UINT_MIN -65536
#endif
#if ( SYSTEM_ARCHITECTURE == SYSTEM_ARCHITECTURE_3232BIT ) || \
    ( SYSTEM_ARCHITECTURE == SYSTEM_ARCHITECTURE_3264BIT ) || \
    ( SYSTEM_ARCHITECTURE == SYSTEM_ARCHITECTURE_64BIT )
/* No emulation of 32BIT and 64BIT targets for 1632BIT C compilers implemented */
// #undef INT_MIN
// #undef INT_MAX
// #undef UINT_MAX
#define INT_MIN -2147483648
